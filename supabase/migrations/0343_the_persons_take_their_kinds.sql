-- 0343 — the corpus's persons take their kinds (ris_v19).
--
...
begin
  ...
  update semantic_private.presumed_terms
   ...
   where normalized_label = '許光漢' and family = 'person'
     and person_subtype is null;
  get diagnostics touched = row_count; n := n + touched;
  raise notice '0343: % of 757 subtype assignments landed', n;
  if 757 > 0 and n = 0 then
    raise exception
      '0343: assignments were emitted and none matched a dictionary row';
  end if;
end;
$$;
